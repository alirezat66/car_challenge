...
class AppTheme {
  ...
  static ThemeData getTheme({required Brightness brightness}) {
    ...
    return ThemeData(
      ...
      colorScheme: ColorScheme(
        ...
        onTertiary: isDark ? darkScaffold : lightSurface,
      ),
  ...
  static DataTableThemeData _getDataTableTheme({required bool isDark}) {
    return DataTableThemeData(
      decoration: BoxDecoration(
        color: isDark
            ? darkSurface
            : Colors.white, // Background color of the table
